import { LayoutDashboard, Users, Stethoscope, Calendar, FileText, BarChart, Settings, User, Building2 } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Consultorios", url: "/admin/consultorios", icon: Building2 },
